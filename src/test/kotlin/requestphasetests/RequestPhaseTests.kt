...
class RequestPhaseTests {
    ...
    private lateinit var allocationHelper: AllocationHelper

    @BeforeEach
    fun setUp() {
        MockitoAnnotations.openMocks(this)
        requestPhase = RequestPhase(dataHolder)
        allocationHelper = AllocationHelper(dataHolder)
    }
...
//        val assignableAssets = allocationHelper.getAssignableAssets(base, requestedVehicles)
...
//        val invalidAssignableAssets = allocationHelper.getAssignableAssets(base, invalidRequestedVehicles)
